...
public class SafeInventory implements Inventory {
    ...
    public void setActiveBlockEntity(SafeBlockEntity blockEntity) {
        this.activeBlockEntity = blockEntity;
    }

    public boolean isActiveBlockEntity(SafeBlockEntity blockEntity) {
